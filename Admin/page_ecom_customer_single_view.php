                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <div class="block">
                                ...
                                <table class="table table-borderless table-striped table-vcenter">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="text-right"><strong>Last Visit "PRO"</strong></td>
                                            <td>06/11/2014 - 09:41</td>
                                        </tr>
                                        <tr>
                                            <td class="text-right"><strong>Registrations "PRO"</strong></td>
                                            <td><span class="label label-primary">Newsletter</span></td>
                                        </tr>
                                        <tr>
                                            <td class="text-right"><strong>Status "PRO"</strong></td>
                            ...
                            <div class="block">
                                <!-- Quick Stats Title -->
                                <div class="block-title">
                                    <h2><i class="fa fa-line-chart"></i> <strong>Quick</strong> Stats "PRO"</h2>
                                </div>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="block">
                                ...
                                <div class="block-title">
                                    ...
                                    <h2><i class="fa fa-truck"></i> <strong>Orders</strong> (4) "PRO"</h2>
                                </div>
                                <!-- END Orders Title -->
                            ...
                            <div class="block">
                                ...
                                <div class="block-title">
                                    ...
                                    <h2><i class="fa fa-shopping-cart"></i> <strong>Products</strong> in Cart (3) "PRO"
                                    </h2>
                                </div>
                            ...
                            <div class="block">
                                ...
                                <div class="block-title">
                                    <h2><i class="fa fa-building-o"></i> <strong>Customer</strong> Addresses "PRO"</h2>
                                </div>
