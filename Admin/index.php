            ...
            <div id="main-container">
                ...
                <div id="page-content">
                    ...
                    <div class="content-header content-header-media">
                        ...
                        <img src="img/placeholders/headers/dashboard_header.jpg" alt="header image"
                                        ...
                                        <ul class="timeline-list">
                                            <li class="active">
                                                ...
                                                <div class="timeline-content">
                                                    <p class="push-bit"><a
                                                            href="page_ready_user_profile.html"><strong>Jordan
                                                                Carter</strong></a></p>
                                                    ...
                                                    <div class="row push">
                                                        <div class="col-sm-6 col-md-4">
                                                            <a href="img/placeholders/photos/photo1.jpg"
                                                                data-toggle="lightbox-image">
                                                                <img src="img/placeholders/photos/photo1.jpg"
                                                                    alt="image">
                                                            </a>
                                                        </div>
                                                        <div class="col-sm-6 col-md-4">
                                                            <a href="img/placeholders/photos/photo22.jpg"
                                                                data-toggle="lightbox-image">
                                                                <img src="img/placeholders/photos/photo22.jpg"
                                                                    alt="image">
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="active">
                                                ...
                                                <div class="timeline-content">
                                                    <p class="push-bit"><a
                                                            href="page_ready_user_profile.html"><strong>Nicole
                                                                Ward</strong></a></p>
                            ...
                            <div class="widget">
                                <div class="widget-extra themed-background-dark">
                                    ...
                                    <h3 class="widget-content-light">
                                        ...
                                        <small><a
                                                href="page_ready_pricing_tables.html"><strong>Upgrade</strong></a></small>
                                    </h3>
                                </div>
