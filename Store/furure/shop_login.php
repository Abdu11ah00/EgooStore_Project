                        ...
                        <div class="shop-product-wrap grid row justify-content-center g-4">
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="product-item">
                                    <div class="product-thumb">
                                        ...
                                        <div class="product-action-link">
                                            <a class="view-modal" data-target="#quick_view"><i
                                    ...
                                    <div class="product-content">
                                        <h5><a href="#">Product Title Here1</a></h5>
                                ...
                                <div class="product-list-item">
                                    ...
                                    <div class="product-content">
                                        <h5><a href="#">Product Title Here2</a></h5>
                                        <p><i class="icofont-star"></i><i class="icofont-star"></i><i
                                                class="icofont-star"></i><i class="icofont-star"></i><i
                                                class="icofont-star"></i></p>
                                        <h6>
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="product-item">
                                    <div class="product-thumb">
                                        ...
                                        <div class="product-action-link">
                                            <a class="view-modal" data-target="#ss"><i class="icofont-eye"></i></a>
                                            <a href="#"><i class="icofont-heart"></i></a>
                                            <a href="#"><i class="icofont-cart-alt"></i></a>
                                        </div>
                                    </div>
                                    <div class="product-content">
                                        <h5><a href="#">Product Title Here3</a></h5>
                                        <p><i class="icofont-star"></i><i class="icofont-star"></i><i
                                                class="icofont-star"></i><i class="icofont-star"></i><i
                                                class="icofont-star"></i></p>
                                        <h6>$2003</h6>
                                ...
                                <div class="product-list-item">
                                    ...
                                    <div class="product-content">
                                        <h5><a href="#">Product Title Here4</a></h5>
                                        <p><i class="icofont-star"></i><i class="icofont-star"></i><i
                                                class="icofont-star"></i><i class="icofont-star"></i><i
                                                class="icofont-star"></i></p>
                                        <h6>
                                    ...
                                    <li>
                                        ...
                                        <ul class="shop-submenu lab-ul">
                                            <li><a href="#0">All Products</a>
                                                <ul class="shop-submenu lab-ul">
                                                    <li><a href="#0" class="active">All Products</a></li>
                            ...
                            <ul class="lab-ul widget-wrapper">
                                <li class="d-flex flex-wrap justify-content-between">
                                    <div class="post-thumb">
                                        <a href="shop-single.html"><img src="assets/images/shop//pp/01.jpg"
                                                alt="product"></a>
                                    </div>
                            ...
                            <div class="footer-middle-item mb-lg-0">
                                ...
                                <div class="fm-item-content">
                                    ...
                                    <ul class="match-social-list d-flex flex-wrap align-items-center">
                                        <li><a href="#"><img src="assets/images/match/Snapchat" alt="vimeo"></a>
                                        </li>
                                        <li><a href="#"><img src="assets/images/match/instagram" alt="youtube"></a>
                                        </li>
                                        <li><a href="#"><img src="assets/images/match/Whatsapp" alt="twitch"></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
